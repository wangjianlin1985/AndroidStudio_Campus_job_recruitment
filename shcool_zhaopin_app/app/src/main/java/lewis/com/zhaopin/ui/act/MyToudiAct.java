...
public class MyToudiAct extends BaseActivity{
    ...
    public void initView() {
        ...
        //给列表绑定adapter并渲染数据
        adapter = new SimpleAdapter<MyToudiList.DataBean>(R.layout.item_toudi, beanList, new SimpleAdapter.ConVert<MyToudiList.DataBean>() {
            @Override
