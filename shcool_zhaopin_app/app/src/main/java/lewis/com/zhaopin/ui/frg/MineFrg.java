...
import lewis.com.zhaopin.ui.act.LoginActivity;
import lewis.com.zhaopin.ui.act.MyJianliAct;

import lewis.com.zhaopin.ui.act.MyMsgAct;

import lewis.com.zhaopin.ui.act.MyStoreAct;
import lewis.com.zhaopin.ui.act.MyToudiAct;
import lewis.com.zhaopin.ui.act.SetAct;
import lewis.com.zhaopin.ui.act.UpPwdAct;
import lewis.com.zhaopin.ui.act.UserInfoAct;
...
public class MineFrg extends BaseFragment{
                        ...
                        if (login!=null&&login.data!=null){
                            getActivity().runOnUiThread(new Runnable() {
                                ...
                                public void run() {
                                    ...
                                    Glide.with(mActivity).load(data.img).into(iv);
    ...
    @OnClick({ R.id.tv_exit, R.id.tv_up_pwd,R.id.my_pwd, R.id.my_jianli,R.id.my_store,R.id.tv_set, R.id.my_toudi, R.id.my_msg})
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.my_pwd:
                ...
                startActivity(new Intent(mActivity,UpPwdAct.class));
                break;
                case R.id.my_store:

                startActivity(new Intent(mActivity,MyStoreAct.class));
                break;
            case R.id.my_msg:
